              ...
              <div className="space-y-4">
                {socialLinks.map((item) => (
                  <Link
                    ...
                    className="flex items-center gap-4 p-4 rounded-lg bg-muted/50 border border-border hover:border-[var(--neon-blue)]/50 hover:shadow-[0_0_12px_rgba(40,128,255,0.2)] transition-all group"
                  >
